...
const CaretDownIcon = () => {
  return (
    <svg className="svg-inline--fa cursor-pointer w-3 h-3  fa-caret-down fa-sm fa-fw" aria-hidden="true" focusable="false" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512">
