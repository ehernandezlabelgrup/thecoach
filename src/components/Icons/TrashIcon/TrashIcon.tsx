...
const TrashIcon = () => {
  return (
    <svg className="svg-inline--fa text-gray-400 fa-trash add-icon" data-prefix="fas" data-icon="trash" aria-hidden="true" focusable="false" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
