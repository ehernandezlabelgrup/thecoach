...
function XMarkIcon() {
    return (
        <svg className="svg-inline--fa fa-xmark fa-sm add-icon" data-prefix="far" data-icon="xmark" aria-hidden="true" focusable="false" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512">
