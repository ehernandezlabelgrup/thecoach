import { TEPopover, TEPopoverContent, TEPopoverToggler } from "tw-elements-react"
...
const ExercisesItems = ({data, onDeleteExercise}: Props) => {
  return (
    <div className="tags add-tags scroll my-1" onClick={e => {
      e.stopPropagation()
    }}>
      ...
      return (
        ...
        >
          ...
          <div className="relative w-5">
            ...
            <button className="aboslute z-0 top-0 left-0 w-full h-full" 
              style={{
                  userSelect: "none",
